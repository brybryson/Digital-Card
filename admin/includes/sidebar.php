<!-- Sidebar -->
<div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white z-50 transition-all duration-300">
    <div class="p-6">
        <div class="sidebar-header flex items-center justify-between mb-8">
            ...
            <button id="sidebar-toggle" class="p-2 rounded-lg hover:bg-gray-700 transition">
        ...
        <nav class="sidebar-nav space-y-2">
            ...
            <a href="users.php" class="flex items-center space-x-3 px-4 py-3 <?php echo basename($_SERVER['PHP_SELF']) === 'users.php' || (basename($_SERVER['PHP_SELF']) === 'user_edit.php' && isset($_GET['id'])) ? 'bg-gray-700' : 'hover:bg-gray-700'; ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                </svg>
                <span class="sidebar-text">Users</span>
            </a>
            <a href="user_edit.php" class="flex items-center space-x-3 px-4 py-3 <?php echo basename($_SERVER['PHP_SELF']) === 'user_edit.php' && !isset($_GET['id']) ? 'bg-gray-700' : 'hover:bg-gray-700'; ?> rounded-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="contacts.php" class="flex items-center space-x-3 px-4 py-3 <?php echo basename($_SERVER['PHP_SELF']) === 'contacts.php' ? 'bg-gray-700' : 'hover:bg-gray-700'; ?> rounded-lg transition">
                ...
                <span class="sidebar-text">Contact Submissions</span>
            </a>
    ...
    <div class="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-700">
        <div class="sidebar-bottom flex items-center space-x-3">
            <div class="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center">
                <span class="text-sm font-semibold"><?php echo strtoupper(substr($_SESSION['admin_name'], 0, 2)); ?></span>
            </div>
            <div class="flex-1">
                <p class="sidebar-text text-sm font-semibold"><?php echo htmlspecialchars($_SESSION['admin_name']); ?></p>
                <p class="sidebar-text text-xs text-gray-400"><?php echo ucfirst($_SESSION['admin_role']); ?></p>
            </div>
        </div>
